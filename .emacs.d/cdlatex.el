...
(defun cdlatex-lr-pair ()
  ...
  (let* ((paren (char-to-string (preceding-char)))
         ...
         (paren1 paren)
         (close1 close))
    (if (string= paren "a") (setq paren1 "\\langle" close1 "|"))
    (if (string= paren "b") (setq paren1 "|" close1 "\\rangle"))
...
(defconst cdlatex-command-alist-default
  '(
    ...
    ("bra"       "Insert a \\left\\langle \\right| pair"
     "a" cdlatex-lr-pair nil nil t)
    ("ket"       "Insert a \\left| \\right\\rangle"
     "b" cdlatex-lr-pair nil nil t)
    ...
    ("braket"         "Insert \\left\\langle \\middle| \\right\\rangle"
     "\\left\\langle? \\middle| \\right\\rangle"           cdlatex-position-cursor nil nil t)
    ("sq"         "Insert \\sqrt{}"
